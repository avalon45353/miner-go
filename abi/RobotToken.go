...
// epoch is a free data retrieval call binding the autogenerated accessor method for the public state variable.
//
// Solidity: function epoch() view returns(uint256)
func (_RobotToken *RobotTokenCaller) Epoch(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _RobotToken.contract.Call(opts, &out, "Epoch")
...
// epoch for session.
func (_RobotToken *RobotTokenSession) Epoch() (*big.Int, error) {
	return _RobotToken.Contract.Epoch(&_RobotToken.CallOpts)
}

// epoch for caller session.
func (_RobotToken *RobotTokenCallerSession) Epoch() (*big.Int, error) {
	return _RobotToken.Contract.Epoch(&_RobotToken.CallOpts)
}
// rewardPerMine is a free data retrieval call binding the autogenerated accessor method for the public state variable.
//
// Solidity: function rewardPerMine() view returns(uint256)
func (_RobotToken *RobotTokenCaller) RewardPerMine(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _RobotToken.contract.Call(opts, &out, "RewardPerMine")
...
// rewardPerMine for session.
func (_RobotToken *RobotTokenSession) RewardPerMine() (*big.Int, error) {
	return _RobotToken.Contract.RewardPerMine(&_RobotToken.CallOpts)
}

// rewardPerMine for caller session.
func (_RobotToken *RobotTokenCallerSession) RewardPerMine() (*big.Int, error) {
	return _RobotToken.Contract.RewardPerMine(&_RobotToken.CallOpts)
}
